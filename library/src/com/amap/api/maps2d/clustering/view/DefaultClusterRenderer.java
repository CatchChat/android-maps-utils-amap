package com.amap.api.maps2d.clustering.view;

import static com.amap.api.maps2d.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
import com.amap.api.maps2d.clustering.ClusterManager;
...
import com.amap.api.maps2d.projection.SphericalMercatorProjection;
import com.amap.api.maps2d.ui.IconGenerator;
import com.amap.api.maps2d.ui.SquareTextView;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    public void onAdd() {
        ...
        mClusterManager.getMarkerCollection().setOnInfoWindowClickListener(new AMap.OnInfoWindowClickListener() {
            @Override
        ...
        mClusterManager.getClusterMarkerCollection().setOnInfoWindowClickListener(new AMap.OnInfoWindowClickListener() {
            @Override
            public void onInfoWindowClick(Marker marker) {
