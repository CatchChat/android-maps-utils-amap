...
public class IconGenerator {
    ...
    private void ensureViewsSetUp() {
        if (mContainer == null) {
            mContainer = (ViewGroup) LayoutInflater.from(mContext).inflate(R.layout.amap__text_bubble, null);
    ...
    private static int getBackground(int style) {
        switch (style) {
            ...
            case STYLE_DEFAULT:
            case STYLE_WHITE:
                return R.drawable.amap__bubble_white;
            case STYLE_RED:
                return R.drawable.amap__bubble_red;
            case STYLE_BLUE:
                return R.drawable.amap__bubble_blue;
            case STYLE_GREEN:
                return R.drawable.amap__bubble_green;
            case STYLE_PURPLE:
                return R.drawable.amap__bubble_purple;
            case STYLE_ORANGE:
                return R.drawable.amap__bubble_orange;
        }
    }
